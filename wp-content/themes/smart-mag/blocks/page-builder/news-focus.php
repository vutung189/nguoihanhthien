...
class Bunyad_PageBuilder_NewsFocus extends Bunyad_PageBuilder_WidgetBase
{
	...
	public function widget($args, $instance)
	{
		...
		// supported attrs
		$attrs = array('posts', 'cat', 'tax_tag', 'sub_cats', 'sub_tags', 'sort_order', 'sort_by', 'highlights', 'offset', 'post_type', 'heading_type', 'heading');
	...
	{
		$defaults = array('posts' => 4, 'cat' => '', 'offset' => 0, 'post_type' => '', 'heading' => '', 'heading_type' => '');

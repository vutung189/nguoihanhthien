			...
			<div class="row">
				<div class="<?php echo $copyright_menu ? 'col-lg-7 col-sm-8' : 'col-sm-12'; ?>">
					<?php if ( $copyright_area ): ?>
						<?php
						echo wp_kses_post( get_theme_mod( 'newsmag_copyright_contents', '&copy; ' . date( "Y" ) . ' <a href="https://www.nguoihanhthien.vn">Nguoihanhthien</a>. ' ) );
						?>
					<?php endif; ?>

					<?php echo __( 'Bản quyền thuộc về <a href="https://www.nguoihanhthien.vn" >Người Hành Thiện</a>', 'newsmag' ) ?>
				</div>

...
class Newsmag_Lite {
	...
	public function enqueues() {
		 ...
		 * Load Google Fonts
		 */
		wp_enqueue_style( 'newsmag-fonts', '//fonts.googleapis.com/css?family=Lato:100,300,400,700,900|Tahoma:400,500,600,700', array(), $newsmag['Version'], 'all' );
	...
	public function admin_enqueues() {
		$newsmag = wp_get_theme();
		wp_enqueue_style( 'newsmag-fonts', 'https://fonts.googleapis.com/css?family=Lato:100,300,400,700,900|Tahoma:400,500,600,700', array(), $newsmag['Version'], 'all' );
